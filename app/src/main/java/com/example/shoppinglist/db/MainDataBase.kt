...
abstract class MainDataBase : RoomDatabase() {
    ...
    companion object {
        ...
        fun getDataBase(context: Context): MainDataBase {
            return INSTANCE ?: synchronized(this) {  //оператор элвиса. Если null, то присваиваится то что справа // synchronized не дает двум потокам делать то же самое
                val instance = Room.databaseBuilder(context.applicationContext, MainDataBase::class.java, "shopping_list.db").build()
                instance
            }
        }
    }
